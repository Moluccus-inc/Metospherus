...
class MedicineReminderWidgetProviderConfigureActivity : Activity() {
    ...
    private var onClickListener = View.OnClickListener {
        val context = this@MedicineReminderWidgetProviderConfigureActivity
    ...
    private lateinit var binding: MedicineReminderWidgetProviderConfigureBinding
    ...
    public override fun onCreate(icicle: Bundle?) {
        ...
        appWidgetText.setText(
            loadTitlePref(
                this@MedicineReminderWidgetProviderConfigureActivity,
                appWidgetId
            )
        )
    }
...
private const val PREFS_NAME = "metospherus.app.widgets.MedicineReminderWidgetProvider"
